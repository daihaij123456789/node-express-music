function MusicVisualizer(obj) {
	...
	this.gainNode=MusicVisualizer.ac[MusicVisualizer.ac.createGain?"createGain":"createGainNode"]();//兼容性
...
MusicVisualizer.prototype.play=function (url) {
	...
	this.load(url,function (arraybuffer) {
		...
		self.decode(arraybuffer,function (buffer) {
			...
			bs.buffer=buffer;
			bs[bs.start?"start":"noteOn"](0);//兼容性
			self.source=bs;
		})
	})
}
...
MusicVisualizer.prototype.start=function (fun) {
